...
**NOTE:** It's important that we keep our current user's information in our
...
- `RECEIVE_CURRENT_USER` - use `Object.assign` to add the action's user to the
...
- Create a container `LoginFormContainer`, another container
